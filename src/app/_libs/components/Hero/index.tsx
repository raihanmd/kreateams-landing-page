...
export default function Hero() {
  return (
    <header className="relative grid place-items-center gap-3 py-20 md:py-32">
      <Image
        draggable={false}
      ...
      <div className="flex flex-col items-center gap-3 text-center">
        <h1 className="text-balance font-neue text-[clamp(2.7rem,_10vw,_5rem)] uppercase leading-[3.5rem] sm:leading-[4.5rem]">
        ...
        <p className="text-balance text-lg font-semibold sm:w-[80%] lg:text-xl">
