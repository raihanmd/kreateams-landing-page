...
const PROGRAMS: TProgram[] = [
  {
    title: "Skill-Boosting Workshops & Learning Labs",
    content:
  ...
  {
    title: "Creative Networking Soirées & Meetups",
    content:
  ...
  {
    title: "Real-world Project Expeditions",
    content:
  ...
  {
    title: "Tailored Mentorship Odyssey",
    content:
