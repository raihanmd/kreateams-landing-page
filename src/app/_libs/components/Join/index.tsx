...
export default function Join() {
  return (
    <div className="h-60 w-full bg-slate-800">
      <div
        className="relative z-[2] flex w-full flex-col items-center justify-center gap-3 overflow-hidden bg-primary-darker py-40 font-grotesk text-4xl font-bold [clip-path:_polygon(0_25%,_100%_0%,_100%_75%,_0%_100%)]"
        id="join"
      >
        <svg
          viewBox="0 0 200 200"
